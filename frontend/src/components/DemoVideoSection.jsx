    ...
    <section id="demo" className="max-w-7xl mx-auto px-5 sm:px-6 py-16 sm:py-24 scroll-mt-20" ref={sectionRef}>
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-ink-500 text-base sm:text-lg max-w-2xl">
          Feed Kadenza a topic and it hands you cinematic video for <span className="font-semibold text-ink-900">YouTube, Instagram, Reels, Facebook and LinkedIn</span> — every format included from a single prompt.
        </p>
      </div>
