...
export default function WaitlistForm({ compact = false, source = "landing_hero" }) {
  ...
  if (joined) {
    ...
    const shareText = `I just joined the ContentOS AI private beta at position #${joined.position} — turn any topic into a ready-to-post video (16:9 + 9:16) in minutes. Reserve your spot 👇`;
    const openLinkedIn = () => {
      window.open(
