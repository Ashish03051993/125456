            ...
            {shareBusy && !shareSlug ? (
              ...
              <>
                ...
                <div className="mt-4 grid grid-cols-4 gap-2" data-testid="share-social-row">
                  {[
                    { id: "twitter", label: "X", icon: Twitter, href: `https://twitter.com/intent/tweet?text=${encodeURIComponent("Made this with ContentOS AI →")}%20${encodeURIComponent(publicUrl)}` },
